...
public class Constants {
	public final static String  url="http://www.automationpractice.com";
    public final static String userID="rsdesaiglb@gmail.com";
    public final static String password="test@123";
    public final static String file_path="G:\\SeleniumLabs\\Practice\\AutomationPracticeStoreMod\\";
